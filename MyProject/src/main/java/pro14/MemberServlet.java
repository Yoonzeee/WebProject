...
public class MemberServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getRequestURI().equals("/MyProject/member/view")) {
		...
		} else if (request.getRequestURI().equals("/MyProject/member/list")) {
			MemberDAO memberDAO = new MemberDAO();
			...
			dispatch.forward(request, response);
		} else if (request.getRequestURI().equals("/MyProject/member/dupUidCheck")) {
			String uid = request.getParameter("uid");
		...
		} else if (request.getRequestURI().equals("/MyProject/member/insert")) {
			String uid = request.getParameter("uid");
			...
			try {
				...
				jsonResult.put("status", true);
				jsonResult.put("url", "/MyProject/main.html");
				jsonResult.put("message", "해당 아이디는 사용가능합니다");
